...
const On_Boarding_Schema = mongoose.Schema({
  ...
  hr: {
    onboard_meet_and_greet_welcome_call: { type: Boolean },
    verify_acenet_email_id_zoho_id_laptop_provision_to_employee: {
      type: Boolean,
    },
    introduction_meeting_with_buddy: { type: Boolean },
    introduction_meeting_with_line_manager_respective_senior_manager: {
      type: Boolean,
    },
    handover_to_project_complete: { type: Boolean },
    introduction_call_with_ceo: { type: Boolean },
